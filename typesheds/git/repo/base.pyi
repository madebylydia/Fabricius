...
class Repo:
    ...
    git: Incomplete
    working_dir: PathLike  # We removed "Optional" because we know we'll always clone entire repos and not bare repos.
    git_dir: PathLike
    ...
    GitCommandWrapperType: Incomplete
    odb: Incomplete
    def __init__(
        self,
    ...
    @property
    def working_tree_dir(
        self,
    ) -> PathLike: ...  # We removed "Optional" because we know we'll always clone entire repos and not bare repos.
    @property
    ...
    def create_head(
        self, path: PathLike, commit: str = ..., force: bool = ..., logmsg: Optional[str] = ...
    ) -> Head: ...
    ...
    def blame(
        self, rev: Union[str, HEAD], file: str, incremental: bool = ..., **kwargs: Any
    ) -> Union[
        List[List[Union[Commit, List[Union[str, bytes]], None]]], Iterator[BlameEntry], None
    ]: ...
    @classmethod
    def init(
        cls,
